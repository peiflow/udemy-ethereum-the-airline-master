...
const converter = (web3) =>{
    return(value) => {
        return web3.fromWei(value.toString(), 'ether');
    }
}
...
export class App extends Component {
    ...
    async componentDidMount(){
        ...
        flightPurchased.watch(function(err, result){
            ...
            {
                console.log(`You purchased a flight to ${flight} whith a cost of ${price}`);
            }else{
    ...
    async refundLoyaltyPoints(){
        await this.airlineService.reddemLoyaltyPoints(this.state.account);
    }
            ...
            <div className="row">
                ...
                <div className="col-sm">
                    <Panel title="Loyalty points - refundable ether">
                        <span>
                            {this.state.refundableEther} eth
                        </span>
                        <button className="btn btn-sm bg-success text-white" onClick={this.refundLoyaltyPoints.bind(this)}>
                            Refund
                        </button>
                    </Panel>
                </div>
